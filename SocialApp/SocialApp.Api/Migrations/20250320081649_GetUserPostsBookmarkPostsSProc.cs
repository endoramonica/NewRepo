...
namespace SocialApp.Api.Migrations
{
    ...
    public partial class GetUserPostsBookmarkPostsSProc : Migration
    {
        ...
        {
            migrationBuilder.Sql(@"CREATE OR ALTER PROC GetUserPosts
                    (
                        @StartIndex INT,
                        @PageSize INT,
                    ...
                    END
");
            migrationBuilder.Sql(@"CREATE OR ALTER PROC GetUserBookmarkedPosts
                    (
                        @StartIndex INT,
                        @PageSize INT,
                        @CurrentUserId UNIQUEIDENTIFIER
        ...
        {
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS GetUserPosts");
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS GetUserBookmarkedPosts");
        }
    }
}
